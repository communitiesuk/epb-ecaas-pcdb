...
pub enum ResolvePcdbProductsError {
    ...
    #[error(
        "Received a product type that is not yet supported. Currently supported products: heat pump, boiler, electric storage heater, radiator, WWHRS, UFH, fan coil, smart hot water tank, heat batteries, and mechanical ventilation."
    )]
